...
export default function AdminDashboard() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden
                    bg-gray-50 text-slate-900 font-sans">

      {/* Sidebar */}
      <aside className={`flex-shrink-0 bg-white border-r
                         border-gray-200 p-4 flex flex-col
                         gap-6 text-left transition-all
                         duration-300 ${
        ...
        <div className="flex items-center justify-between
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-gray-50
                       ...
                       font-mono text-sm mx-auto border
        ...
        <nav className="flex flex-col gap-1 flex-1">
          <button
            ...
            className={`w-full flex items-center gap-3
                        font-medium text-sm px-3 py-2.5
        ...
        <div className={`text-[10px] text-gray-400 border-t
